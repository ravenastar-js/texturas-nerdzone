        ...
        const vipData = [
            {
                ...
                features: [
                    ...
                    "§7Acesso aos §aKits VIP Diário",
                    "§7Acesso aos §aKits VIP Semanal",
                    "§7Acesso aos §aKits VIP Mensal",
                    ...
                    "§7Delay de §a4min 30s §7para ativar redstone"
                ],
                featured: false,
            ...
            },
            {
                ...
                features: [
                    ...
                    "§7Delay de §b4min §7para ativar redstone"
                ],
                featured: false,
                buyUrl: "https://loja.nerdzone.gg/itens"
            },
            {
                ...
                features: [
                    ...
                    "§7Acesso aos §bkits MVP§6+ §bMensais",
                    "§7Acesso a §b4 Terrenos",
                    "§7Falar §bcolorido §7no chat",
                    "§7Delay de §b4s §7para teleportar no skygrid",
                    "§7Não perde §bXP §7ao morrer",
                    "§7Acesso ao comando §b/fly",
                    "§7Delay de §b3min 30s §7para ativar redstone"
                ],
                featured: false,
                buyUrl: "https://loja.nerdzone.gg/itens"
            },
            {
                ...
                features: [
                    ...
                    "§7Delay de §e2min 30s §7para ativar redstone"
                ],
                featured: false,
                buyUrl: "https://loja.nerdzone.gg/itens"
            },
            {
                ...
                colorClass: "vip-last",
                features: [
                    "§7Para ver as vantagens desse vip acesse o servidor e utilize o comando §d/vantagens",
                ],
                featured: false,
                buyUrl: "https://loja.nerdzone.gg/itens"
            }
